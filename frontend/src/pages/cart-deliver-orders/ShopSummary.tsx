...
export const ShopSummary = () => {
  ...
  const handleBuyProducts = () => {
    /* una vez finalizada la compra se podría eliminar todo el localStorage para que todo desde cero */
    ...
    toast.success("Satisfactory purchase!", {
      autoClose: 1500,
      pauseOnHover: false,
      position: "bottom-right",
      onClose: () => {}, // se podría enviar al home o a la ruta de las órdenes "orders" para hacer un seguimiento
    });
  };
  ...
  return (
    <div className="flex flex-col py-5 sm:py-10 border-t w-full">
      ...
      <div className="w-full flex flex-col gap-8 bg-gray-100 p-2 rounded-md">
