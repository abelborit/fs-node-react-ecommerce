...
export class AuthController {
  ...
  public loginUser(request: Request, response: Response): void {
    response.status(200).json({ message: "loginUser" });
  }

  public registerUser(request: Request, response: Response): void {
    response.status(200).json({ message: "registerUser" });
  }

  public adminUser(request: Request, response: Response): void {
